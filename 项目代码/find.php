	...
	<body>
		...
		<div class="showBigDiv">
			<div class="showLeftDiv">						<!--设置在左边边框和内容的显示-->
				...
				<div class="showFindLink">
					<a class="showLink" href="find.php?things=./data/findClasses/campuscard.txt">##校园卡</a>
				</div>
				<div class="showFindLink">
					<a class="showLink" href="find.php?things=./data/findClasses/key.txt">##钥匙</a>
				</div>
				<div class="showFindLink">
					<a class="showLink" href="find.php?things=./data/findClasses/IDcard.txt">##身份证</a>
				</div>
				<div class="showFindLink">
					<a class="showLink" href="find.php?things=./data/findClasses/bankcard.txt">##银行卡</a>
				</div>
				<div class="showFindLink">
					<a class="showLink" href="find.php?things=./data/findClasses/flashdisk.txt">##U盘</a>
				</div>
				<div class="showFindLink">
					<a class="showLink" href="find.php?things=./data/findClasses/wallet.txt">##钱包</a>
				</div>
				<div class="showFindLink">
					<a class="showLink" href="find.php?things=./data/findClasses/cellphone.txt">##手机</a>
				</div>
				<div class="showFindLink">
					<a class="showLink" href="find.php">##当前所有信息</a>
				</div>
			</div>
			...
			?>
				...
				<div class="showNextPage">
					<?php
						...
						{
					?>
					<a href="find.php?page=<?= ($thisPage-1)."&amp;things=".$things ?>">上一页</a>
					<?php
						}
					?>
					<?php
						...
						{
					?>
					<a href="find.php?page=<?= ($thisPage+1)."&amp;things=".$things ?>">下一页</a>
					<?php
						}
					?>
